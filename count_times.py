    ...
    with open(filename, "r") as log:
        for line in log:
            ...
            if match_create is not None:
                ...
                create_job[ip_address].append(
                    (dict_object["owner"], get_time(date)))
                continue
...
print "Total of {} jobs took {}".format(
    total_jobs, get_time_in_hours(total_time))
print "Total of {} NMPI jobs took {}".format(
    total_NMPI_jobs, get_time_in_hours(total_NMPI_time))
print "Total of {} Machine test jobs took {}".format(
    total_machine_test_jobs, get_time_in_hours(total_machine_test_time))
print "Total of {} Other jobs took {}".format(
    total_other_jobs, get_time_in_hours(total_other_time))
